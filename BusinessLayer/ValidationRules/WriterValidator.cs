...
namespace BusinessLayer.ValidationRules
{
    public class WriterValidator: AbstractValidator<Writer>
    {
        public WriterValidator()
        {
            ...
            RuleFor(w => w.WriterAbout).MinimumLength(50).WithMessage("En az 50 karakter girişi yapılabilir");
            RuleFor(w => w.WriterAbout).MaximumLength(200).WithMessage("En fazla 200 karakter girişi yapılabilir");
            RuleFor(w => w.WriterSurname).MinimumLength(2).WithMessage("En fazla 2 karakter girişi yapılabilir");
